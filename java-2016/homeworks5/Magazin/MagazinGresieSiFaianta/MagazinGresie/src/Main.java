...
public class Main {
	...
	public static void main(String[] args) {
		...
		double PTTileSideLength = 0.3;  // 30 cm = 0.3 m 
		...
		System.out.println("Cost for covering the surface with P-type tiles: " + pTileCost + " lei.");
		...
		System.out.println("Cost for covering the surface with splited tiles: " + splitCost + " lei.");
	

		double PTTIleCost = calculatePTTileCost(surfaceToCover, priceForPTTile,  PTTileSideLength );
		System.out.println("Cost for covering the surface with PT-type tiles: " + PTTIleCost + " lei.");
	}
